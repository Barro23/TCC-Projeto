...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="1000">
      <img src="img/exemploBaner1.jpg" class="" style=" object-fit: conver; width: 100%;  -webkit-mask-image: linear-gradient(to top, transparent 5%, white 35%);"">
    </div>
...
<div  class="container" style="margin-top: -13%; position: relative;" >
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-3">

            <div class="col">
              <p><h1 style="margin-left: 20px;">texto</h1></p>
