<?php
    ...
    if ($acao == "salvarTextoInSalvarProfs"){
        $id_usuario = $_POST["id_usuario"];
        $id_texto = $_POST["id_texto"];
        ...
        echo '<script>location ="../../?secoes=salvosProf";</script>';

        
        
    } if ($acao == "deletarTextosInSalvarProfs"){
        $id = $_POST["id"];
    ...
    if ($acao == "salvarPdfsInSalvarProfs"){
        $id_usuario = $_POST["id_usuario"];
        $id_pdf = $_POST["id_pdf"];
    ...
    } if ($acao == "deletarPdfsInSalvarProfs"){
        $id = $_POST["id"];
